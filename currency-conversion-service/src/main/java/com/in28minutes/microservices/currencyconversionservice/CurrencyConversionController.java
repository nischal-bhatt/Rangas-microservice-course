...
public class CurrencyConversionController {
			...
			)
	{
		...
		return new CurrencyConversion(cc.getId(),cc.getFrom(),cc.getTo(),quantity,cc.getConversionMultiple(),quantity.multiply(cc.getConversionMultiple()),cc.getEnvironment() + " rest template ");
	}
